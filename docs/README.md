...
<img src="/public/env_notification.pngg" alt="notification you get" width="auto" height="150">
...
<img src="/public/myenv.png" alt="how you can tell that u'r inside the envirment" width="auto" height="150">
...
This is normal text, and <small>this is smaller text using the `<small>` tag.</small>

This is normal text, and <span style="font-size: small;">this is smaller text using inline CSS.</span>

This is normal text, and <sub>this is subscript text.</sub>

This is normal text, and <sup>this is superscript text.</sup> </br>
